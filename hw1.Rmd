...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Mike Brown** and I am majoring in *Mathematics*. I have lived in Ankeny, IA for almost my entire life and I am ready to move away from here! I enjoy being outside and experiencing nature, but during the cold season I like to just stay inside and play video games. My goal is to graduate next year and hopefully find a job somewhere out west.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: The work of a [Statistician](https://money.usnews.com/careers/best-jobs/statistician) comes to mind when thinking about a data science job since I am a math major. Statisticians take or record large amounts of data and use statistics applications to interpret it in a way that best fits the employers needs. Statisticians can be found in just about any industry due to the universal need for analysis. ![Statistician examining data](https://www.ziprecruiter.com/blog/static/wp-content/uploads/2019/11/28160552/912637018_Statistician-628x353.jpg)
    
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I enjoy datasets involving cars.
